  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Kesari Devaraya",
          from_email: form.email,
          to_email: "kesaridevaraya@gmail.com",
          message: form.message,
          title: "Recruiter contacted via portolio"
        },
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-ctnPrimaryDark text-xs" >Email Free Teir expired plz contact manually </span>
      </form>
    </motion.div>
  );
}
